...
public interface RaceRepository extends JpaRepository<Race, Long> {
    ...
    default List<WeeklyRaceReport> getWeeklyReportByUserId(@Param("userId") Long userId, EntityManager entityManager) {
        ...
        return new ArrayList<WeeklyRaceReport>(query.getResultList());
    }
}
